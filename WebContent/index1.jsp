...
%>
<h3>Welcome <%=name%> to deluxe home</h3>
<div class="container">

<!-- Header Starts -->
<div class="header">
<a href="index1.jsp"><img src="images/logo11.png" alt="Realestate"></a>

              <ul class="pull-right">
                <li><a href="buy.jsp">Buy</a></li>
                <li><a href="sell.jsp">Sale</a></li>         
                <li><a href="Rentto.jsp">Renter</a></li>
  ...
  <div class="container"> 
    <!-- banner -->
        <div class="col-lg-5 col-lg-offset-1 col-sm-6 ">
          ...
          <button class="btn btn-info"   data-toggle="modal"  onclick="location.href='EditP.jsp';">Edit Profile</button></div>
         <ul class="pull-centre" >
       <li style="font-size:40px;"><a href="saleadd.jsp">your Sale Add</a></li>
        </ul>
        <ul class="pull-centre">
      <li style="font-size:40px;"><a href="renteradd.jsp">your Renter Add</a></li>
      </ul>
      </div>
    </div>
